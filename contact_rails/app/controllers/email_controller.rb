class EmailController < ApplicationController
  def create
    ...
    return render res(200, 'Message successfully sent!') if SpamFilter.message_filter(msg_body) || SpamFilter.message_filter(msg_subject) || SpamFilter.sender_filter(sender_name)
